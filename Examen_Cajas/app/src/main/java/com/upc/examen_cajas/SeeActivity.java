...
public class SeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserRepository userRepository = new UserRepository(SeeActivity.this);
        ...
        editFloatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SeeActivity.this, UpdateUserActivity.class);
        ...
        deleteFloatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SeeActivity.this);
